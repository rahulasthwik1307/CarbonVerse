...
[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-CarbonVerse-00C853?style=for-the-badge&logoColor=white)](https://carbon-verse-nu.vercel.app/)
[![Tech Stack](https://img.shields.io/badge/⚡_Built_With-Next.js_16-000000?style=for-the-badge&logo=next.js&logoColor=white)](https://nextjs.org/)
[![AI Powered](https://img.shields.io/badge/🤖_AI-Groq_+_Llama-F55036?style=for-the-badge&logo=meta&logoColor=white)](https://groq.com/)
[![Deployed On](https://img.shields.io/badge/▲_Deployed_On-Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://vercel.com/)
...
![Framer Motion](https://img.shields.io/badge/Framer_Motion-12-E91BDE?style=flat-square&logo=framer&logoColor=white)
...
│                                                     │
│   🏠 Landing Page                                   │
│   │  Immersive 3D hero with parallax storytelling   │
│   ▼                                                 │
│   👤 Personalization                                │
│   │  Name, avatar, sustainability context           │
│   ▼                                                 │
│   📖 Interactive Story                              │
│   │  6 pivotal daily life decisions                 │
│   ▼                                                 │
│   🤖 AI Narration                                   │
│   │  Groq-powered contextual storytelling           │
│   ▼                                                 │
│   📊 Carbon Calculation                             │
│   │  Real-time impact scoring per choice            │
│   ▼                                                 │
│   🌆 Future Simulator                               │
│   │  Visualize your world in 2050                   │
│   ▼                                                 │
│   🌳 Memory Garden                                  │
│   │  Living garden that grows with your choices     │
│   ▼                                                 │
│   📖 Memory Book                                    │
│   │  Personal timeline of your journey              │
│   ▼                                                 │
│   🏆 Achievements & Missions                        │
│   │  Unlockable badges + personalized actions       │
│   ▼                                                 │
│   🔍 Receipt Detective                              │
│   │  AI receipt analysis for real-world tracking    │
│   ▼                                                 │
│   💬 Verd AI Assistant                              │
│       Conversational sustainability coach           │
│                                                     │
└─────────────────────────────────────────────────────┘
```
...
|---|---|---|
| **Framework** | ![Next.js](https://img.shields.io/badge/Next.js_16-000?style=flat-square&logo=next.js) | App Router, Server Components, API Routes |
| **Language** | ![TypeScript](https://img.shields.io/badge/TypeScript_5-3178C6?style=flat-square&logo=typescript&logoColor=white) | Type-safe development across the stack |
| **Styling** | ![Tailwind](https://img.shields.io/badge/Tailwind_CSS_4-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) | Utility-first responsive design system |
| **Animation** | ![Framer Motion](https://img.shields.io/badge/Framer_Motion-E91BDE?style=flat-square&logo=framer&logoColor=white) | Smooth micro-animations & page transitions |
| **3D Graphics** | ![Three.js](https://img.shields.io/badge/Three.js-000?style=flat-square&logo=three.js) | Immersive 3D landing experience |
| **Animation** | ![GSAP](https://img.shields.io/badge/GSAP-88CE02?style=flat-square&logo=greensock&logoColor=white) | Advanced scroll & timeline animations |
| **State** | ![Zustand](https://img.shields.io/badge/Zustand_5-443E38?style=flat-square) | Lightweight, scalable global state |
| **UI Components** | ![Radix](https://img.shields.io/badge/Radix_UI-161618?style=flat-square) ![shadcn/ui](https://img.shields.io/badge/shadcn/ui-000?style=flat-square) | Accessible, composable primitives |
| **AI Engine** | ![Groq](https://img.shields.io/badge/Groq-F55036?style=flat-square) | Ultra-fast LLM inference |
| **AI Models** | ![Llama](https://img.shields.io/badge/Llama-0467DF?style=flat-square&logo=meta&logoColor=white) | Context-aware generation & analysis |
| **Audio** | ![Tone.js](https://img.shields.io/badge/Tone.js-000?style=flat-square) | Ambient soundscapes & audio feedback |
| **Icons** | ![Lucide](https://img.shields.io/badge/Lucide-F56565?style=flat-square) | Consistent, beautiful iconography |
| **Deployment** | ![Vercel](https://img.shields.io/badge/Vercel-000?style=flat-square&logo=vercel) | Edge-optimized global deployment |
...
┌───────────────────────────────────────────────────────────────┐
│                        USER LAYER                             │
│  Landing · Onboarding · Story · Detective · Memory · Coach    │
├───────────────────────────────────────────────────────────────┤
│                                                               │
│  ┌─────────────┐  ┌──────────────┐  ┌──────────────────────┐ │
│  │ Story Engine │  │ Receipt      │  │  Verd AI Assistant   │ │
│  │             │  │ Detective    │  │                      │ │
│  │ 6 Scenes    │  │             │  │  Context-Aware Chat  │ │
│  │ Decisions   │  │ Image → AI  │  │  Sustainability      │ │
│  │ Narration   │  │ Analysis    │  │  Guidance             │ │
│  └──────┬──────┘  └──────┬──────┘  └──────────┬───────────┘ │
│         │                │                     │              │
├─────────▼────────────────▼─────────────────────▼──────────────┤
│                CARBON INTELLIGENCE LAYER                      │
│                                                               │
│  Carbon Scoring · AQI Calculation · World State Engine        │
│  Impact Analysis · Emission Mapping · Future Projection       │
├───────────────────────────────────────────────────────────────┤
│                     AI LAYER (Groq)                           │
│                                                               │
│  ┌─────────────────────────────────────────────────────────┐  │
│  │  API Routes: /api/story · /api/detective · /api/coach   │  │
│  │  Model: Llama · Inference: Groq · Streaming Responses   │  │
│  └─────────────────────────────────────────────────────────┘  │
├───────────────────────────────────────────────────────────────┤
│                    MEMORY SYSTEM                              │
│                                                               │
│  Zustand Store · Memory Book · Memory Garden · Journey Log    │
├───────────────────────────────────────────────────────────────┤
│                  ACHIEVEMENT ENGINE                           │
│                                                               │
│  Badge Evaluation · Mission Generation · Progress Tracking    │
└───────────────────────────────────────────────────────────────┘
```
...
```
  User Choice
       ...
       ▼
  ┌─────────────┐
  │   Carbon     │──── Calculates precise CO₂ impact
  │   Impact     │
  └──────┬──────┘
         │
         ▼
  ┌─────────────┐
  │ World State  │──── Updates AQI, temperature, environment
  │  Changes     │
  └──────┬──────┘
         │
         ▼
  ┌─────────────┐
  │   Future     │──── Re-renders 2050 city visualization
  │ Simulation   │
  └──────┬──────┘
         │
         ▼
  ┌─────────────┐
  │ Memory Book  │──── Logs decision + outcome to timeline
  │  Updates     │
  └──────┬──────┘
         │
         ▼
  ┌─────────────┐
  │  Mission     │──── AI generates targeted action items
  │ Generation   │
  └──────┬──────┘
         │
         ▼
  ┌─────────────┐
  │ Achievement  │──── Evaluates & unlocks earned badges
  │  Unlocks     │
  └─────────────┘
```

> **Every single choice creates a ripple effect across six interconnected systems.** Nothing exists in isolation.
...
git clone https://github.com/your-username/carbonverse.git
...
![Framer Motion](https://img.shields.io/badge/Framer_Motion-E91BDE?style=for-the-badge&logo=framer&logoColor=white)
